...
class Facade:
    ...
    def get_realtor_listings(self) -> str:
        ...
        realtor_dot_com_bot = RealtorDotComWebScraper(driver, self.city, self.minimum_price, self.maximum_price,
                                                      self.property_type)
    ...
    def get_trulia_listings(self) -> str:
        driver = webdriver.Firefox()
        trulia_bot = TruliaWebScraper(driver, self.city, self.minimum_price, self.maximum_price,
                                      self.property_type)
